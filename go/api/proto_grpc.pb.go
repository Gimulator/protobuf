...
type MessageAPIClient interface {
	...
	Put(ctx context.Context, in *Message, opts ...grpc.CallOption) (*emptypb.Empty, error)
	Delete(ctx context.Context, in *Key, opts ...grpc.CallOption) (*emptypb.Empty, error)
	DeleteAll(ctx context.Context, in *Key, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *messageAPIClient) GetAll(ctx context.Context, in *Key, opts ...grpc.CallOption) (MessageAPI_GetAllClient, error) {
	stream, err := c.cc.NewStream(ctx, &MessageAPI_ServiceDesc.Streams[0], "/api.MessageAPI/GetAll", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *messageAPIClient) Put(ctx context.Context, in *Message, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *messageAPIClient) Delete(ctx context.Context, in *Key, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (c *messageAPIClient) DeleteAll(ctx context.Context, in *Key, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (c *messageAPIClient) Watch(ctx context.Context, in *Key, opts ...grpc.CallOption) (MessageAPI_WatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &MessageAPI_ServiceDesc.Streams[1], "/api.MessageAPI/Watch", opts...)
	if err != nil {
		return nil, err
	}
...
type MessageAPIServer interface {
	...
	Put(context.Context, *Message) (*emptypb.Empty, error)
	Delete(context.Context, *Key) (*emptypb.Empty, error)
	DeleteAll(context.Context, *Key) (*emptypb.Empty, error)
...
func (UnimplementedMessageAPIServer) Put(context.Context, *Message) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Put not implemented")
}
func (UnimplementedMessageAPIServer) Delete(context.Context, *Key) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Delete not implemented")
}
func (UnimplementedMessageAPIServer) DeleteAll(context.Context, *Key) (*emptypb.Empty, error) {
...
type DirectorAPIClient interface {
	GetActors(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (DirectorAPI_GetActorsClient, error)
	PutResult(ctx context.Context, in *Result, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *directorAPIClient) GetActors(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (DirectorAPI_GetActorsClient, error) {
	stream, err := c.cc.NewStream(ctx, &DirectorAPI_ServiceDesc.Streams[0], "/api.DirectorAPI/GetActors", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *directorAPIClient) PutResult(ctx context.Context, in *Result, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type DirectorAPIServer interface {
	GetActors(*emptypb.Empty, DirectorAPI_GetActorsServer) error
	PutResult(context.Context, *Result) (*emptypb.Empty, error)
...
func (UnimplementedDirectorAPIServer) GetActors(*emptypb.Empty, DirectorAPI_GetActorsServer) error {
	return status.Errorf(codes.Unimplemented, "method GetActors not implemented")
}
func (UnimplementedDirectorAPIServer) PutResult(context.Context, *Result) (*emptypb.Empty, error) {
...
func RegisterDirectorAPIServer(s grpc.ServiceRegistrar, srv DirectorAPIServer) {
	s.RegisterService(&DirectorAPI_ServiceDesc, srv)
}
...
// DirectorAPI_ServiceDesc is the grpc.ServiceDesc for DirectorAPI service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var DirectorAPI_ServiceDesc = grpc.ServiceDesc{
...
type OperatorAPIClient interface {
	SetUserStatus(ctx context.Context, in *Report, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *operatorAPIClient) SetUserStatus(ctx context.Context, in *Report, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type OperatorAPIServer interface {
	SetUserStatus(context.Context, *Report) (*emptypb.Empty, error)
...
func (UnimplementedOperatorAPIServer) SetUserStatus(context.Context, *Report) (*emptypb.Empty, error) {
...
type UserAPIClient interface {
	ImReady(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *userAPIClient) ImReady(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (c *userAPIClient) Ping(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type UserAPIServer interface {
	ImReady(context.Context, *emptypb.Empty) (*emptypb.Empty, error)
...
func (UnimplementedUserAPIServer) ImReady(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ImReady not implemented")
}
func (UnimplementedUserAPIServer) Ping(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
...
func _UserAPI_ImReady_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserAPIServer).ImReady(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserAPI_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserAPIServer).Ping(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
